<script>
    ...
    let sourceShorts = $state([
        { id: 1, title: "Eerste Short", videoUrl: "/test_videos/video1.mp4", creator: "Davidnet", liked: false, views: 1420, likesCount: 112, watchDuration: 18, videoLength: 20 },
        { id: 2, title: "Tweede Short", videoUrl: "/test_videos/video2.mp4", creator: "Davidnet", liked: false, views: 890, likesCount: 64, watchDuration: 12, videoLength: 15 },
        { id: 3, title: "Derde Short", videoUrl: "/test_videos/video3.mp4", creator: "Davidnet", liked: false, views: 2310, likesCount: 310, watchDuration: 28, videoLength: 30 },
        { id: 4, title: "Vierde Short", videoUrl: "/test_videos/video4.mp4", creator: "Davidnet", liked: false, views: 540, likesCount: 22, watchDuration: 8, videoLength: 10 },
        { id: 5, title: "Vijfde Short", videoUrl: "/test_videos/video5.mp4", creator: "Davidnet", liked: false, views: 1100, likesCount: 95, watchDuration: 22, videoLength: 25 },
        { id: 6, title: "Zesde Short", videoUrl: "/test_videos/video6.mp4", creator: "Davidnet", liked: false, views: 340, likesCount: 18, watchDuration: 5, videoLength: 12 },
        { id: 7, title: "Zevende Short", videoUrl: "/test_videos/video7.mp4", creator: "Davidnet", liked: false, views: 4200, likesCount: 512, watchDuration: 45, videoLength: 45 },
        { id: 8, title: "8de Short", videoUrl: "/test_videos/video8.mp4", creator: "Davidnet", liked: false, views: 780, likesCount: 45, watchDuration: 10, videoLength: 14 },
        { id: 9, title: "Bimbambini sixseveni", videoUrl: "/test_videos/video9.mp4", creator: "Davidnet", liked: false, views: 6700, likesCount: 890, watchDuration: 58, videoLength: 60 }
    ]);
            ...
            (entries) => {
                entries.forEach((entry) => {
                    ...
                    if (entry.isIntersecting) {
                        ...
                        if (video) {
                            // Forceer herladen als de browser de video had laten hangen
    ...
    <div class="shorts-container" bind:this={containerElement}>
        {#each feed as short, index (short.feedId)}
            <div
                ...
                <!-- preload="auto" voor actieve en nabije video's, metadata voor de rest om netwerkstalling te voorkomen -->
                <video
                    src={short.videoUrl}
                    loop
                    muted
                    ...
                    oncanplay={(e) => { e.target.currentTime = 0.1; }}
                        ...
                        <div class="panel-content">
                            {#if activePanel.type === "info"}
                                <div class="info-content">
                                    ...
                                    <p><strong>Creator:</strong> @{short.creator}</p>
                                    <p><strong>Video ID:</strong> {short.id}</p>
                                    ...
                                    <p><strong>Likes:</strong> {short.likesCount + (short.liked ? 1 : 0)}</p>
                                    <p><strong>Watch Duration:</strong> {short.watchDuration}s</p>
                                    <p><strong>Video Length:</strong> {short.videoLength}s</p>
                                </div>
